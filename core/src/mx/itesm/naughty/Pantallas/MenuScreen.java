...
public class MenuScreen extends MainScreen {
    ...
    private void crearEscena() {
        ...
        btnAcerca.setPosition(0.10f*ANCHO_PANTALLA-btnAcerca.getWidth()/2, 0.10f*ALTO_PANTALLA-btnAcerca.getHeight()/2);
        btnAyuda.setPosition(0.86f*ANCHO_PANTALLA-btnAyuda.getWidth()/2, 0.12f*ALTO_PANTALLA-btnAyuda.getHeight()/2);
